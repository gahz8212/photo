...
const styles = StyleSheet.create({
  ...
  loginBox: { backgroundColor: '#fff', padding: 20, borderRadius: 15, elevation: 5 }, // elevation은 안드로이드 그림자
  ...
  button: { height: 50, backgroundColor: '#007AFF', borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginTop: 10 },
